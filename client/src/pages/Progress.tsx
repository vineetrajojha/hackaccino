...
const Progress = () => {
  return (
    <div className="space-y-8 min-h-screen bg-gradient-to-br from-red-50 via-white to-pink-50 p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm">
          ...
          <div className="space-y-4">
            {["Perfect Pitch Master", "Fluency Champion", "Weekly Goal Crusher"].map((achievement, index) => (
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm">
        ...
        <div className="space-y-4">
          {[1, 2, 3].map((entry) => (
            <div key={entry} className="flex items-center gap-4 p-4 bg-gray-50 rounded-lg">
              ...
              <button className="text-red-500 hover:text-red-600">Play Recording</button>
            </div>
          ))}
        </div>
      </div>
